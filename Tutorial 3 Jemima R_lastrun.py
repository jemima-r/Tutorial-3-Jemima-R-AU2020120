...
expName = 'Tutorial 3 Jemima R'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\JEMIMA\\Documents\\L in Psych Psychopy\\Tutorial 3 Jemima R_lastrun.py',
